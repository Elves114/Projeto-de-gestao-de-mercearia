...
public class ProdutoService {
    ...
    public ProdutoResponse buscarPorId(
        ...
        Produto produto =
                buscarProdutoDaEmpresa(id, empresaId);
    ...
    public void eliminar(
        ...
        /*
         * Não devemos eliminar um produto que possui
         * histórico de vendas.
         *
         * Essa verificação será adicionada quando
         * o VendaRepository estiver implementado.
         */
