...
public class UsuarioController {
     ...
     * ============================================================
     *
     * Sem @PreAuthorize — qualquer utilizador autenticado
     * pode alterar a sua própria senha. A identidade é
     * obtida do contexto de segurança, não do URL.
     */

    @Operation(
            summary = "Alterar a minha senha",
            description = """
                    Permite ao utilizador autenticado alterar
                    a sua própria senha.

                    É necessário informar a senha atual para
                    validar a operação.
