...
public class UsuarioDetails implements UserDetails {
    ...
    /**
     * A conta é considerada "não bloqueada" enquanto não existir
     * um bloqueio temporário activo.
     *
     * O bloqueio é gerido por LoginTentativaService, que grava em
     * "bloqueadoAte" o momento em que o bloqueio termina.
     *
     * Não existe no domínio um estado "BLOQUEADO" permanente — o
     * valor Status.BLOQUEADO existe no enum mas nunca é atribuído
     * por nenhum serviço.
     */
    @Override
